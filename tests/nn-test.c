...
int main(void) {
    ...
    Linear *linear = linear_create(3, 2, NULL);
    ...
    MLP *mlp = mlp_create(mlp_sizes, 3, NULL);
    ...
    MLP *train_mlp = mlp_create(mlp_sizes, 3, NULL);
    int n_params = 0;
    ...
    MLP *line_mlp = mlp_create(line_sizes, 3, NULL);
    int line_n_params = 0;
    ...
    MLP *adam_mlp = mlp_create(line_sizes, 3, NULL);
    int adam_n_params = 0;
